...
function authErrorMessage(error, activeView = 'login') {
  ...
  if (message.includes('provider is not enabled') || message.includes('unsupported provider') || message.includes('validation_failed')) {
    return 'Google sign-in is not enabled yet. Please ask the admin to turn on Google Auth, or use email login.';
  }
  if (message.includes('popup') || message.includes('redirect')) {
    return 'Google sign-in was cancelled or blocked. Please allow popups/redirects and try again.';
  }
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="bg-white dark:bg-gray-900 px-3 font-semibold uppercase tracking-wide text-gray-400">
